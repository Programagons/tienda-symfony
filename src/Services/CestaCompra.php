...
class CestaCompra {
    ...
    # Guardamos el estado actual de la cesta en la sesión
    protected function guardar_cesta() {
        # Obtenemos la sesión
        $sesion = $this->requestStack->getSession();
        
        # Persistimos los productos y unidades en la sesión
        $sesion->set('productos',$this->productos);
        $sesion->set('unidades',$this->unidades);
    }

    # Devolvemos el array de productos de la cesta
    public function get_Productos() {
        # Cargamos la cesta antes de devolver los datos
        $this->cargar_cesta();
        return $this->productos;
    }

    # Devolvemos el array de unidades de la cesta
    ...
    public function cargar_productos($productos, $unidades) {
        ...
        # Cargamos los productos en la sesión recorriendo los recibidos del formulario
